...
//define and get parameter
  ...
  ArrayList<OnewayTicketPlan> searchResult= (ArrayList<OnewayTicketPlan>)request.getAttribute("list"); 

  session.setAttribute("List",searchResult); 
...
<%//for 循环输出arraylist %>
       <% int a=1;
          int indexPlan=-1;
          for(OnewayTicketPlan i:searchResult)
          {
          indexPlan++;
